...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : MOTOR_STBY_Pin MOTOR_AIN1_Pin MOTOR_AIN2_Pin MOTOR_BIN1_Pin
                           MOTOR_BIN2_Pin */
  GPIO_InitStruct.Pin = MOTOR_STBY_Pin|MOTOR_AIN1_Pin|MOTOR_AIN2_Pin|MOTOR_BIN1_Pin
                          |MOTOR_BIN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
