...
typedef struct { uint8_t x, y; Direction facing; float yaw; float target_yaw; } RobotPose;
...
/* ===================== VL53L0X x4 ===================== */
/*
 * Physical XSHUT wiring:
 *   L_FWD  -> PB0
 *   L_DIAG -> PB1
 *   R_DIAG -> PA1
 *   R_FWD  -> PA2
 *
 * All four sensors share I2C1 (PB8/PB9).
 */
#define VL53_COUNT 4
#define VL53_LEFT_XSHUT_PORT GPIOB
#define VL53_LEFT_XSHUT_PIN GPIO_PIN_0
#define VL53_FL_XSHUT_PORT GPIOB
#define VL53_FL_XSHUT_PIN GPIO_PIN_1
#define VL53_FR_XSHUT_PORT GPIOA
#define VL53_FR_XSHUT_PIN GPIO_PIN_1
#define VL53_RIGHT_XSHUT_PORT GPIOA
#define VL53_RIGHT_XSHUT_PIN GPIO_PIN_2
